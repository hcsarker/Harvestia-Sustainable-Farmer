...
delete from public.quiz_questions
 where quiz_id like '%nasa%'
    or quiz_id like '%harvestia%'
    or quiz_id like '%farming%';
delete from public.quizzes
 where id like '%nasa%'
    or id like '%harvestia%'
    or id like '%farming%';
...
insert into public.quiz_questions (
   ...
   nasa_data_reference
           ...
           'NASA কী ধরনের data প্রদান করে যা চাষাবাদে কাজে লাগে?',
           ...
           '{"nasa_services": ["soil_monitoring", "crop_health", "weather", "precipitation"], "technology": "satellite_remote_sensing"}'
                                                                                                                                         ...
                                                                                                                                         'কেন NASA data চাষাবাদের জন্য গুরুত্বপূর্ণ?'
                                                                                                                                         ,
                                                                                                                                         ...
                                                                                                                                         'nasa-basics'
                                                                                                                                         ,
                                                                                                                                                                                                                                                                                 'বাংলাদেশের মতো ছোট দেশেও কি NASA satellite data পাওয়া যায়?'
                                                                                                                                                                                                                                                                                 ,
...
insert into public.quizzes (
   ...
   questions_count,
   attempts_allowed
) values ( 'harvestia-nasa',
           'Harvestia App এ NASA Data',
           'Easy',
           'App Features',
           0,
           5 );
...
insert into public.quiz_questions (
   ...
   nasa_data_reference
           ...
           'Harvestia Dashboard এ কোন NASA data দেখতে পাবেন?',
           ...
           '{"dashboard_data": ["MODIS_NDVI", "SMAP_soil_moisture", "GPM_precipitation"]}' ),( 'harvestia-nasa',
                                                                                               'Agricultural Simulation এ location select করলে কী হয়?'
                                                                                               ,
                                                                                               ...
                                                                                               '{"simulation_feature": "location_specific_NASA_data", "realism": "actual_satellite_data"}'
                                                                                                                                                                                           ...
                                                                                                                                                                                           'Weather section এ কোন NASA data পাবেন?'
                                                                                                                                                                                           ,
...
insert into public.quizzes (
   ...
   questions_count,
   attempts_allowed
) values ( 'practical-nasa',
           'বাস্তব NASA Data প্রয়োগ',
           'Medium',
           'Practical Use',
           0,
           3 );
...
insert into public.quiz_questions (
   ...
   nasa_data_reference
           ...
           'আপনার ধানের জমির NDVI 0.3 দেখাচ্ছে। কী করবেন?',
           ...
           '{"crop": "rice", "NDVI_poor": "<0.4", "NDVI_healthy": "0.6-0.8", "action": "irrigation_fertilization"}' ),( 'practical-nasa'
           ,
                                                                                                                        'Soil moisture 15% এবং 3 দিন বৃষ্টি নেই। কী করবেন?'
                                                                                                                        ,
                                                                                                                        ...
                                                                                                                        ,
                                                                                                                                                                                                                  'GPM data বলছে 2 দিনে 20mm বৃষ্টি। কী করবেন?'
                                                                                                                                                                                                                  ,
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  'practical-nasa'
                                                                                                                                                                                                                  ,
                                                                                                                                                                                                                                                                                                                      'NDVI trend 2 সপ্তাহ ধরে কমছে। সম্ভাব্য কারণ কী?'
                                                                                                                                                                                                                                                                                                                      ,
...
insert into public.quiz_questions (
   ...
   nasa_data_reference
           ...
           'NDVI map এ সবুজ, হলুদ, লাল রঙের মানে কী?',
           ...
           '{"color_coding": {"green": ">0.6_healthy", "yellow": "0.3-0.6_moderate", "red": "<0.3_poor"}}' ),( 'nasa-interpretation'
           ,
                                                                                                               'Humidity 90% দেখাচ্ছে। কী সমস্যা হতে পারে?'
                                                                                                               ,
                                                                                                               ...
                                                                                                               ,
                                                                                                                                                                                                      'Winter এ গমের NDVI 0.4। এটা কি চিন্তার বিষয়?'
                                                                                                                                                                                                      ,
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      'nasa-interpretation'
                                                                                                                                                                                                      ,
                                                                                                                                                                                                                                                                                             'NDVI=0.8, Soil Moisture=40%, Temperature=35°C। সামগ্রিক অবস্থা?'
                                                                                                                                                                                                                                                                                             ,
...
insert into public.quizzes (
   ...
   questions_count,
   attempts_allowed
) values ( 'nasa-advanced',
           'উন্নত NASA Data ব্যবহার',
           'Hard',
           'Advanced Techniques',
           0,
           3 );
...
insert into public.quiz_questions (
   ...
   nasa_data_reference
           ...
           'বিভিন্ন ফসলের জন্য NDVI threshold আলাদা কেন?',
           ...
           '{"crop_specific": "different_thresholds", "factors": ["leaf_structure", "growth_pattern"]}' ),( 'nasa-advanced',
                                                                                                            'Variable Rate Application কী?'
                                                                                                            ,
                                                                                                            ...
                                                                                                            ,
                                                                                                                                                                                       'Climate change এর জন্য NASA long-term data কীভাবে ব্যবহার করবেন?'
                                                                                                                                                                                       ,
...
select 'NASA Data Quiz System Setup Complete!' as message,
       (
          select count(*)
            from public.quizzes
           where id like '%nasa%'
