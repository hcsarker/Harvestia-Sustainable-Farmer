...
insert into public.quizzes (
   ...
   attempts_allowed
           ...
           'NASA Data Basics for Smart Farming',
           'Easy',
           'NASA Earth Data Introduction',
           0,
           3 );
...
insert into public.quiz_questions (
   ...
   explanation
           ...
           'কোন NASA satellite থেকে soil moisture data পাওয়া যায়?',
           ...
           'SMAP (Soil Moisture Active Passive) satellite মাটির আর্দ্রতা পরিমাপ করে যা irrigation planning এর জন্য খুব গুরুত্বপূর্ণ।'
                                                                                                                                      ...
                                                                                                                                      'nasa-basics'
                                                                                                                                      ,
                                                                                                                                                                                                                                                 'GPM satellite কী ধরনের data প্রদান করে?'
                                                                                                                                                                                                                                                 ,
                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                 'nasa-basics'
                                                                                                                                                                                                                                                 ,
                                                                                                                                                                                                                                                                                                                                                     'NASA POWER থেকে কোন weather data পাওয়া যায়?'
                                                                                                                                                                                                                                                                                                                                                     ,
...
insert into public.quizzes (
   ...
   questions_count,
   attempts_allowed
) values ( 'nasa-practical',
           'Practical NASA Data for Daily Farming',
           'Medium',
           'Farm Application',
           0,
           3 );
...
insert into public.quiz_questions (
   ...
   explanation
           ...
           'কখন irrigation করবেন SMAP soil moisture data দেখে?',
           '["যখন soil moisture 50% এর উপরে", "যখন soil moisture 20% এর নিচে", "সবসময়", "কখনোই না"]',
           'যখন soil moisture 20% এর নিচে',
           'SMAP data যখন soil moisture 20% এর নিচে দেখায় তখন গাছের জন্য পানির অভাব, তাই irrigation প্রয়োজন।' ),( 'nasa-practical'
           ,
                                                                                                                    'MODIS NDVI data কীভাবে crop health monitor করতে সাহায্য করে?'
                                                                                                                    ,
                                                                                                                    ...
                                                                                                                    ,
                                                                                                                                                                                                                    'GPM precipitation data দিয়ে কী সিদ্ধান্ত নিতে পারেন?'
                                                                                                                                                                                                                    ,
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    'nasa-practical'
                                                                                                                                                                                                                    ,
                                                                                                                                                                                                                                                                                                                              'কোন NASA data combination irrigation এর জন্য সবচেয়ে কার্যকর?'
                                                                                                                                                                                                                                                                                                                              ,
...
insert into public.quiz_questions (
   ...
   explanation
           ...
           'NDVI time series analysis কীভাবে crop yield prediction এ সাহায্য করে?',
           ...
           'Growing season জুড়ে NDVI এর pattern, peak values, এবং decline rate দেখে crop health ও expected yield estimate করা যায়।'
                                                                                                                                      ...
                                                                                                                                      'Drought detection এর জন্য কোন NASA data combination সবচেয়ে কার্যকর?'
                                                                                                                                      ,
                                                                                                                                      ...
                                                                                                                                      'nasa-advanced'
                                                                                                                                      ,
                                                                                                                                                                                                                                                          'কীভাবে NASA data দিয়ে fertilizer application optimize করবেন?'
                                                                                                                                                                                                                                                          ,
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          'nasa-advanced'
                                                                                                                                                                                                                                                          ,
                                                                                                                                                                                                                                                                                                                                                                        'Crop stress early detection এর জন্য কোন approach সবচেয়ে ভাল?'
                                                                                                                                                                                                                                                                                                                                                                        ,
...
insert into public.quizzes (
   ...
   questions_count,
   attempts_allowed
) values ( 'nasa-seasonal',
           'Seasonal Crop Planning with NASA Data',
           'Medium',
           'Seasonal Planning',
           0,
           3 );
...
insert into public.quiz_questions (
   ...
   explanation
           ...
           'বর্ষা season এ কোন NASA data সবচেয়ে গুরুত্বপূর্ণ?',
           ...
           'বর্ষায় excessive rainfall এবং waterlogging এড়াতে precipitation ও soil moisture একসাথে monitor করা জরুরি।' ),( 'nasa-seasonal'
           ,
                                                                                                                        'শুকনো মৌসুমে crop planning এর জন্য কী করবেন?'
                                                                                                                        ,
                                                                                                                        ...
                                                                                                                        ,
                                                                                                                                                                                                                                                               'নতুন ক্ষেত select করার সময় NASA data কীভাবে সাহায্য করে?'
                                                                                                                                                                                                                                                               ,
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               'nasa-seasonal'
                                                                                                                                                                                                                                                               ,
                                                                                                                                                                                                                                                                                                                                                                                            'Climate change adaptation এর জন্য NASA data কীভাবে ব্যবহার করবেন?'
                                                                                                                                                                                                                                                                                                                                                                                            ,
...
update public.quizzes
   ...
   questions_count = (
      select count(*)
        from public.quiz_questions
       where quiz_id = 'nasa-seasonal'
   )
 where id = 'nasa-seasonal';

-- Display success message
select 'NASA Quiz Setup Complete!' as status,
