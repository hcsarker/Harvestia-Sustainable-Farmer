...
('nasa-satellite-data', 'NASA Satellite Data for Agriculture', 'Medium', 'Satellite Remote Sensing', 0, 3);
...
('nasa-satellite-data', 'What does NDVI (Normalized Difference Vegetation Index) measure?',
 ...
 '{"source": "MODIS", "bands": ["NIR", "Red"], "formula": "(NIR - Red) / (NIR + Red)"}'),

('nasa-satellite-data', 'Which NASA satellite program provides soil moisture data?',
...
('nasa-satellite-data', 'What is the typical spatial resolution of MODIS NDVI data?',
...
('nasa-satellite-data', 'GPM (Global Precipitation Measurement) provides data on:',
...
('nasa-satellite-data', 'Which spectral bands are most useful for crop monitoring?',
...
INSERT INTO public.quizzes (id, title, difficulty, nasa_topic, questions_count, attempts_allowed) VALUES
('nasa-climate-data', 'NASA Climate Data for Farming', 'Hard', 'Climate Science', 0, 3);

-- Add climate data questions
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_answer, explanation, nasa_data_reference) VALUES
('nasa-climate-data', 'NASA POWER provides which agricultural parameters?',
 ...
 '{"source": "NASA_POWER", "parameters": ["T2M", "RH2M", "ALLSKY_SFC_SW_DWN", "WS10M", "PRECTOTCORR"]}'),

('nasa-climate-data', 'What does the SMAP L4 product provide for agriculture?',
...
('nasa-climate-data', 'Which NASA dataset helps predict drought conditions?',
...
('nasa-climate-data', 'How often does NASA GPM provide global precipitation data?',
...
('nasa-climate-data', 'What is the advantage of using NASA Earth data for precision agriculture?',
...
UPDATE public.quizzes SET questions_count = (
    SELECT COUNT(*) FROM public.quiz_questions WHERE quiz_id = 'nasa-satellite-data'
) WHERE id = 'nasa-satellite-data';

UPDATE public.quizzes SET questions_count = (
    SELECT COUNT(*) FROM public.quiz_questions WHERE quiz_id = 'nasa-climate-data'
) WHERE id = 'nasa-climate-data';

-- Create Advanced NASA Applications Quiz
INSERT INTO public.quizzes (id, title, difficulty, nasa_topic, questions_count, attempts_allowed) VALUES
('nasa-advanced-apps', 'Advanced NASA Data Applications', 'Hard', 'Data Integration', 0, 3);

-- Add advanced application questions
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_answer, explanation, nasa_data_reference) VALUES
('nasa-advanced-apps', 'How can MODIS NDVI time series help farmers?',
 ...
 '{"application": "crop_phenology", "temporal_resolution": "8-day", "methodology": "time_series_analysis"}'),

('nasa-advanced-apps', 'Which combination of NASA data is best for irrigation scheduling?',
...
('nasa-advanced-apps', 'What does anomaly detection in NDVI time series reveal?',
...
('nasa-advanced-apps', 'How can NASA data support crop yield prediction?',
...
('nasa-advanced-apps', 'What is the benefit of using NASA data for sustainable agriculture?',
...
UPDATE public.quizzes SET questions_count = (
    SELECT COUNT(*) FROM public.quiz_questions WHERE quiz_id = 'nasa-advanced-apps'
) WHERE id = 'nasa-advanced-apps';

-- Success message
SELECT 'NASA-focused quiz questions created successfully!' as result,
       (SELECT COUNT(*) FROM public.quiz_questions WHERE quiz_id LIKE 'nasa%') as total_questions_added;